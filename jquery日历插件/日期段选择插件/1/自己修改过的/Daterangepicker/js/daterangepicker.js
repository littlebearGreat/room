            ...
            if (cal.hasClass('left')) {
                ...
                if (typeof this.dateLimit === 'object') {
                    ...
                    if (endDate.isAfter(maxDate)) {
                        var tt_dateLimit = this.dateLimit;
                        if (tt_dateLimit.layerMsg) {
                            var tt_msgText = '最大时间间隔不能超过' + tt_dateLimit.days + '天',
                                tt_msgTime = {time:500};
                            if (tt_dateLimit.layerMsgTime && Number(tt_dateLimit.layerMsgTime)) {
                                tt_msgTime.time = Number(tt_dateLimit.layerMsgTime);
                            };
                            layer.msg(tt_msgText,tt_msgTime);
                        }else if(tt_dateLimit.alertMsg){
                            alert('最大时间间隔不能超过' + tt_dateLimit.days + '天');
                        };
                        endDate = maxDate;
                    }
                }
