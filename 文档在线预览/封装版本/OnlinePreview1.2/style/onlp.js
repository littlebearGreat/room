...
(function(){
    // 加载css
    var css1 = '<link rel="stylesheet" href="style/pdf/viewer.css"/>',
        css2 = '<link rel="resource" type="application/l10n" href="style/pdf/locale/locale.properties"/>';
    document.write(css1);
    document.write(css2);
    ...
    var swstr = '<div id="flexP" style="width: 100%;height: 100%;"><div id="flashContent" class="flashContentDiv"> <p style="font-size:20px;margin-bottom:20px;margin-top:60px;"> Flash版本需要不低于 10.0.0 </p> <script type="text/javascript"> var pageHost = ((document.location.protocol == "https:") ? "https://" : "http://"); $("#flashContent").append("<a href=' + "'http://www.adobe.com/go/getflashplayer'><img src='" + '" + pageHost + "www.adobe.com/images/shared/download_buttons/get_flash_player.gif' + "' alt='Get Adobe Flash player' /></a>" + '" ); </script> </div></div>';
